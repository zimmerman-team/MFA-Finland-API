...
import { AF_DEFAULT_TIED_STATUS_CODE } from "../../../static/apiFilterFields";
import { tiedStatusCodelist } from "./codelists";

export function getDefaultTiedStatusOptions(filterString = "*:*") {
  return new Promise((resolve, reject) => {
    const values = {
      ...
      "json.facet": JSON.stringify({
        items: {
          type: "terms",
          field: AF_DEFAULT_TIED_STATUS_CODE,
          limit: -1
        }
      }),
      rows: 0
